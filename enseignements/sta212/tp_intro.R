...
require(class)
# on charge le jeu de données mixture.example sans installer la librairie ElemStatLearn
...
# On récupère les proportions de votes de la classe majoritaire pour chaque point du jeu de données test 
