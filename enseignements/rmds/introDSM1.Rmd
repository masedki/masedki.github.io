...
- Les parties 2.2 et 2.3 font appel à des notions comme la régression linéaire multiple et la validation croisée. J'expliquerai brièvement ces notions en présentiel. Pour ceux qui suivent à distante, je vous conseille la lecture des parties 3.1, 3.2 et 5.1 du
[livre](http://masedki.github.io/enseignements/pdfs/ISLR.pdf) en attendant la mise à jour du poly. Le but est de saisir les idées générales sans se perdre dans les détails formels.
- [Codes R](http://masedki.github.io/enseignements/rcode/code_intro.R) issu de la première séance. Les détails de chaque instruction sont données en commentaires
précédés par un #. 
