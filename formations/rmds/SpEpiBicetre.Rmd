...
- [Choix de modèle dans la famille des k-nn par validation croisée à l'aide de la librairie \textsf{caret} et parallélisation sous R](http://masedki.github.io/formations/rcode/cv_knn.R) 
...
- Choix d'une forêt aléatoire à l'aide de \textsf{caret} (régression et classification). 

- Choix d'un modèle de gradient boosting à l'aide de \textsf{caret} (régression et classification). 
